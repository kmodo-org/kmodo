...
export default function SponsorDashboard() {  
    ...
    const [companyName] = useState("Microsoft");
    ...
    const [companyMissionStatement] = useState("Our mission is to empower every person and every organization on the planet to achieve more.");
    ...
    const [companyPhotoURL] = useState("/images/Microsoft.png");
    ...
    const [companyDescription] = useState(" We develop and market software, services, and hardware devices that deliver new opportunities and enhanced value to people's lives ");
    
    const [companyLocation] = useState("Redmond, WA");
    // const [companyLocation, setCompanyLocation] = useState("Redmond, WA");

    const [employeeCount] = useState(228000);
    // const [employeeCount, setEmployeeCount] = useState(228000);


    const [companyContacts] = useState("Phone: 1-800-MICROSOFT"); // would be []
    ...
    const [companySites] = useState("www.microsoft.com/en-us/");
