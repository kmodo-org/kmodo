...
const TosSections: React.FC = () => {
  ...
  return (
    <div className="bg-background text-foreground p-4 rounded-lg ">
      <Card className="max-w-6xl mx-auto overflow-hidden shadow-none">

        <CardContent>
          <div className="flex flex-col md:flex-row gap-6">
            <div className="md:w-1/4 relative">
                <button
                className="md:hidden mb-4 px-4 py-2 rounded bg-white text-black transition-colors block mx-auto"
                onClick={() => setShowToc(!showToc)}
                >
                {showToc ? "X" : "Table of Contents"}
                </button>
              <nav
                className={`
                  ${showToc ? "block" : "hidden"} 
                  md:block 
                  ${isSticky ? "fixed top-16" : "relative"} 
                  p-4 rounded transition-all duration-200
                `}
              >
                <h2 className="mt-4 text-2xl font-bold pb-2">
                  Table of Contents
                </h2>
                <ul className="list-disc ml-4">
                  <li>
                    <a className="tos-scroll hover:underline" href="#our-services">
                      1. Our Services
                    </a>
                  </li>
                  <li>
                    <a className="tos-scroll hover:underline" href="#intellectual-rights">
                      2. Intellectual Rights
                    </a>
                  </li>
                  <li>
                    <a className="tos-scroll hover:underline" href="#user-representations">
                      3. User Representations
                    </a>
                  </li>
                  <li>
                    <a className="tos-scroll hover:underline" href="#user-registration">
                      4. User Registration
                    </a>
                  </li>
                  <li>
                    <a className="tos-scroll hover:underline" href="#prohibited-activities">
                      5. Prohibited Activities
                    </a>
                  </li>
                  <li>
                    <a className="tos-scroll hover:underline" href="#indemnification">
                      6. Indemnification
                    </a>
                  </li>
                  <li>
                    <a className="tos-scroll hover:underline" href="#warranties-and-disclaimers">
                      7. Warranties and Disclaimers
                    </a>
                  </li>
                  <li>
                    <a className="tos-scroll hover:underline" href="#limitation-of-liability">
                      8. Limitation of Liability
                    </a>
                  </li>
                  <li>
                    <a className="tos-scroll hover:underline" href="#term-and-termination">
                      9. Term and Termination
                    </a>
                  </li>
                  <li>
                    <a className="tos-scroll hover:underline" href="#general-terms">
                      10. General Terms
                    </a>
                  </li>
                </ul>
            ...
            <div className="flex-1">
              <div className="mb-8" ref={summaryRef}>
                <h2 className="mt-8 text-2xl font-bold pb-2">
                  Summary
                </h2>
                    <p>
                ...
                <h2 id="our-services" className="mt-8 text-2xl font-bold pb-2">1. Our Services</h2>
                <p>
                ...
                <h2 id="intellectual-rights" className="mt-8 text-2xl font-bold pb-2">2. Intellectual Rights</h2>
                <p>
                ...
                <h2 id="user-representations" className="mt-8 text-2xl font-bold pb-2">3. User Representations</h2>
                ...
                <p className="mt-4">
                  <strong>Survival.</strong> If we terminate your right to access the Site, these Terms will terminate and all rights you have to access the Site will immediately 
                  terminate. The following provisions will survive termination: Intellectual Property, Indemnification, Payment Obligations, Warranties and Disclaimers, Limitations 
                  of Liability, Dispute and any and all others that by their sense and context are intended to survive the termination or expiration of the Agreement shall survive.
                </p>
                ...
                <p className="mt-4">
                  ...
                  and you must use the following email address: <a className="tos-scroll" href="mailto:admin@kmodo.org">admin@kmodo.org</a>.
                </p>
                <p className="mt-4">
