    ...
    return( 
        <div className="p-10">
            <div className="w-60 h-60 sm:w-64 sm:h-64 bg-[#4264AC] rounded-3xl p-4 text-justify space-y-1  transition-transform hover:scale-105">
                <div className="sm:w-20 w-16 h-16 sm:h-20 bg-[#DBDBF1] rounded-xl flex items-center justify-center">
                    <Image src={props.image} width={45} height={45} alt="icon" className="object-contain" />
                </div>
